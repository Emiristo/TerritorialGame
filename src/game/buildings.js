export const BUILDING_TYPES = {
  ...
  SAWMILL: { id: 'sawmill', name: 'Лесопилка', width: 2, height: 3, cost: { planks: 2, stone: 2 }, terrainId: 'forest', workerTypeId: 'lumberjack', toolId: 'axe', workRadius: 5, input: {}, output: { resourceId: 'wood', amount: 1 }, productionTime: 15, role: 'extraction' },
  ...
  FARM: { id: 'farm', name: 'Ферма', width: 4, height: 4, cost: { planks: 4, stone: 3 }, terrainId: 'plains', workerTypeId: 'farmer', toolId: 'scythe', workRadius: 0, workArea: { width: 4, height: 4, usableCells: 14 }, input: {}, output: { resourceId: 'wheat', amount: 1 }, productionTime: 30, role: 'production' },
  ...
  COAL_MINE: { id: 'coal_mine', name: 'Угольная шахта', width: 2, height: 2, cost: { planks: 4 }, terrainId: 'mountains', workerTypeId: 'miner', toolId: 'pickaxe', workRadius: 5, input: { food: 1 }, output: { resourceId: 'ore', amount: 1 }, productionTime: 15, role: 'extraction' },
  IRON_MINE: { id: 'iron_mine', name: 'Железная шахта', width: 2, height: 2, cost: { planks: 4 }, terrainId: 'mountains', workerTypeId: 'miner', toolId: 'pickaxe', workRadius: 5, input: { food: 1 }, output: { resourceId: 'ore', amount: 1 }, productionTime: 15, role: 'extraction' },
  GOLD_MINE: { id: 'gold_mine', name: 'Золотая шахта', width: 2, height: 2, cost: { planks: 4 }, terrainId: 'mountains', workerTypeId: 'miner', toolId: 'pickaxe', workRadius: 5, input: { food: 1 }, output: { resourceId: 'ore', amount: 1 }, productionTime: 15, role: 'extraction' },
  ...
  OUTPOST: { id: 'outpost', name: 'Форпост', width: 2, height: 2, cost: { planks: 3 }, terrainId: null, workerTypeId: 'soldier', toolId: null, workRadius: null, influenceMultiplier: 0.75, requiredSoldiers: 1, role: 'military' },
  BARRACKS: { id: 'barracks', name: 'Казарма', width: 3, height: 3, cost: { planks: 3, stone: 1 }, terrainId: null, workerTypeId: 'soldier', toolId: null, workRadius: null, influenceMultiplier: 1, requiredSoldiers: 3, role: 'military' },
  WATCHTOWER: { id: 'watchtower', name: 'Сторожевая башня', width: 2, height: 2, cost: { planks: 5, stone: 5 }, terrainId: null, workerTypeId: 'soldier', toolId: null, workRadius: null, influenceMultiplier: 1.25, requiredSoldiers: 6, role: 'military' },
  FORTRESS: { id: 'fortress', name: 'Крепость', width: 5, height: 5, cost: { planks: 10, stone: 10 }, terrainId: null, workerTypeId: 'soldier', toolId: null, workRadius: null, influenceMultiplier: 1.5, requiredSoldiers: 9, blockChanceBonus: 0.05, role: 'military' },
};
...
export function canBuildOnTile(state, typeId, tileId, ownerId = state.player.id) {
  ...
  return tile.ownerId === ownerId && (type.terrainId === null || tile.terrain === type.terrainId);
}
