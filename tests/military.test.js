...
describe('military core', () => {
  ...
  test('rank upgrade consumes one coin and adds one rank in the garrison building', () => {
    ...
    createSoldierFromStorage(
      { ...state, buildings: [{ id: 'w1', typeId: 'warehouse', ownerId: 'p1', inventory: { sword: 1, food: 1 } }] },
      'unused',
      'p1',
      'w1',
    );
    const soldier = { id: 's1', ownerId: 'p1', rank: 1, status: 'available', garrisonBuildingId: null };
    state.military = { soldiers: [soldier], orders: [] };
